...
async function generate() {
    ...
    <style>
      ...
      th, td { border: 1px solid black; padding: 12px; text-align: left; font-size: 18px; }
      th { font-weight: bold; }
    ...
    // Screenshot just the table element to get a perfectly cropped image
    const table = await page.$('table');
    await table.screenshot({ path: 'C:\\Users\\Helios\\Downloads\\Test_Cases_Table.png' });
