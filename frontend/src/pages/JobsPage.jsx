            ...
            <div style={{ padding: '2rem', display: 'grid', gridTemplateColumns: '1.8fr 1.2fr', gap: '2.5rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', paddingLeft: '1.5rem', borderLeft: '1px solid var(--border)' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
                  ...
                  <DetailItem icon={<DollarSign size={14} />} label="Salary" value={(!selectedJob.salary || /^[\s\-]*$/.test(selectedJob.salary) || selectedJob.salary === 'null') ? 'Competitive' : selectedJob.salary} />
                </div>
    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
      <div style={{ flex: 1 }}>
        ...
        <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-muted)', fontSize: '0.95rem' }}>
            <DollarSign size={18} color="var(--primary)" /> {(!job.salary || /^[\s\-]*$/.test(job.salary) || job.salary === 'null') ? 'Competitive' : job.salary}
          </div>
        </div>
      </div>
